...
module.exports.plugins = [
  ...
  [require('remark-lint-code-block-style'), ['error', 'indented']],
  ...
  /* Not used: remark-lint-fenced-code-flag */
  /* Not used: remark-lint-fenced-code-marker */
  ...
  // This preset enforces hard wrapping except for nodes which cannot be wrapped, such as
  // headings, tables, code, links, images and definitions.
  ...
  [require('remark-lint-no-duplicate-headings'), ['warn']],
